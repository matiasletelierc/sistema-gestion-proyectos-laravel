...
<head>
    ...
    <title>✏️ Editar {{ $project->name }} - Gestión de Proyectos</title>
...
<body>
    <div class="container">
        ...
        <div class="card animate-fade-in-up">
            <h2>✏️ Editar Proyecto: {{ $project->name }}</h2>
            ...
            <form action="{{ route('projects.update', $project->id) }}" method="POST" class="project-form">
                ...
                <div class="grid grid-2">
                    <div class="form-group">
                        ...
                        <input type="text" id="name" name="name" value="{{ old('name', $project->name) }}" required placeholder="Ej: Sistema de Gestión">
                        @error('name')
                ...
                <div class="grid grid-2">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="responsible" name="responsible" value="{{ old('responsible', $project->responsible) }}" required placeholder="Ej: Juan Pérez">
                        @error('responsible')
                            <span class="error" style="color: #fecaca; font-size: 0.9rem; margin-top: 0.5rem; display: block;">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="amount" name="amount" value="{{ old('amount', $project->amount) }}" step="0.01" min="0" required placeholder="Ej: 150000">
                    @error('amount')
                        <span class="error" style="color: #fecaca; font-size: 0.9rem; margin-top: 0.5rem; display: block;">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-actions" style="display: flex; gap: 1rem; margin-top: 2rem; justify-content: center; flex-wrap: wrap;">
                    ...
                    <a href="{{ route('projects.show', $project->id) }}" class="btn btn-secondary" style="min-width: 150px; text-align: center;">
                        👁️ Ver Proyecto
                    </a>
                    <a href="{{ route('projects.index') }}" class="btn btn-warning" style="min-width: 150px; text-align: center;">
                        📋 Volver a Lista
                    </a>
                </div>
            </form>
